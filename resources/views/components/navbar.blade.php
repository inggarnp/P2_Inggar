            ...
            <div class="d-flex align-items-center gap-1">
                        ...
                        <div data-simplebar style="max-height: 280px;">
                            ...
                            <a href="javascript:void(0);" class="dropdown-item py-3 border-bottom text-wrap">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        <p class="mb-0"><span class="fw-medium">Shawn Bunch</span> commented on admin panel <span>" Wow 😍! this admin looks good and awesome design"</span></p>
                                    </div>
                                </div>
                            </a>
                        </div>
                ...
                <div class="dropdown topbar-item">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="#">
                            <i class="bx bx-wallet text-muted fs-18 align-middle me-1"></i><span class="align-middle">My Wallet</span>
                        </a>
                        <a class="dropdown-item" href="#">
